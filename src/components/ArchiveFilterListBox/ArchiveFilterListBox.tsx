...
const ArchiveFilterListBox: FC<ArchiveFilterListBoxProps> = ({
  ...
  if (!lists || !selected) {
    return null; // Return null if lists or selected is undefined
  }
      ...
      <Listbox value={selected} onChange={onChange}>
        <div className="relative">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute right-0 z-50 py-1 mt-2 overflow-auto text-sm bg-white shadow-lg w-52 text-neutral-900 dark:text-neutral-200 rounded-xl max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-neutral-900 dark:ring-neutral-700">
