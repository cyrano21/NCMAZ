    ...
    return (
      <main className="relative">
        ...
        <div className="aspect-w-9 aspect-h-9 md:aspect-h-5 rounded-3xl lg:rounded-[40px] overflow-hidden">
          ...
          {/* CONTENT */}
          <div className="absolute flex flex-col justify-end max-w-2xl p-5 group dark md:w-1/2 lg:w-2/3 lg:p-14">
            <div className="">
              <h2 className="text-base font-semibold text-white md:text-xl lg:text-2xl xl:text-3xl hover:text-neutral-300">
                <Link to={href} className="line-clamp-3">
                  {title}
                </Link>
              </h2>
              <span className="hidden mt-5 text-base lg:block text-neutral-200">
                {desc}
              </span>
            </div>
        ...
        <div className="md:absolute mt-5 md:mt-0 h-96 md:h-auto md:right-3 md:top-3 md:bottom-3 md:w-1/2 lg:w-1/3 p-5 lg:p-8 bg-neutral-100 md:bg-white md:dark:bg-neutral-900 dark:bg-neutral-800 xl:bg-opacity-80 xl:dark:bg-opacity-80 xl:backdrop-filter xl:backdrop-blur-xl rounded-3xl lg:rounded-[34px] overflow-hidden">
          <div className="flow-root w-full h-full overflow-y-auto hiddenScrollbar">
            <div className="-my-5 divide-y md:-my-7 divide-neutral-200 dark:divide-neutral-700">
              {subPosts.map((post, i) => (
                <div key={i} className="block py-5 lg:py-7">
                  <h2 className="text-sm font-semibold nc-card-title lg:text-base">
