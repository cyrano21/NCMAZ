    ...
    <div className="relative nc-PageHome">
      <div className="container relative">
        ...
        <SectionSliderNewCategories
          ...
          subHeading="Découvrez 233 sujets"
        ...
        <div className="relative py-16">
          ...
          <SectionSliderPosts
            postCardName="card9"
            heading="Explorez les derniers articles audio"
            subHeading="Cliquez sur l'icône pour profiter de la musique ou du podcast 🎧"
      ...
      <div className="container ">
        ...
        <div className="relative py-16">
          ...
          <SectionSliderPosts
            postCardName="card11"
            heading="Plus d'articles sur la conception"
            subHeading="Plus de 1118 articles"
