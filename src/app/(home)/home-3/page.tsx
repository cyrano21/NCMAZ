...
const PageHomeDemo3: React.FC = () => {
  return (
    <div className="relative nc-PageHomeDemo3">
          ...
          heading={
            <span>
              ...
              <span className="relative pr-3">
                <Image
                  className="absolute w-full transform -translate-y-1/2 top-1/2 -left-1"
                  src={Vector1}
                  alt=""
                />
                <span className="relative">Cœur</span>
              </span>
            </span>
          }
          btnText="Démarrage"
          subHeading="Restez chez vous et partagez avec tout le monde les plus belles histoires de votre ville natale 🎈"
        />
